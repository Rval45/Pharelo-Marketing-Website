    ...
    <div>
      ...
      >
        ...
        <input
          ...
          disabled={loading}
          className="h-14 flex-1 rounded-full border border-border bg-surface px-6 text-base text-foreground placeholder:text-foreground-subtle focus:outline-none focus:ring-2 focus:ring-peach-500/40 focus:ring-offset-2 focus:ring-offset-background sm:border-0 sm:bg-transparent sm:focus:ring-offset-0 disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={loading}
