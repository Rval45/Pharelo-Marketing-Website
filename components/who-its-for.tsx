...
const scenarios = [
  {
    ...
    image: '/images/chronic-condition.png',
  ...
  },
  {
    ...
    image: '/images/caring-for-parent.png',
  ...
  },
  {
    ...
    image: '/images/big-appointment.png',
            ...
            {scenarios.map((scenario, i) => (
              ...
              >
                <div className="py-10 md:py-12 border-t border-border">
                  <div className="grid grid-cols-1 sm:grid-cols-[1fr_140px] gap-6 items-start">
                    {/* Text */}
                    <div>
                    ...
                    {/* Photo accent */}
                    <div className="relative w-[140px] h-[140px] rounded-2xl overflow-hidden shadow-[0_8px_24px_-8px_rgba(61,43,31,0.08)] shrink-0 hidden sm:block">
                      <Image
                        src={scenario.image}
